                        ...
                        <div className="row ">
                            ...
                            <div className="col-md-6 text-center">
                                ...
                                <div className="panel-heading">
                                    ...
                                    <select className="btn btn-default" id="sort_list" onChange={props.sort_list}>
                            ...
                            <div className="col-md-6 text-center">
                                ...
                                <div className="panel-heading">
                                   ...
                                   <div id="usr-opt">
                                    ...
                                    <select className="btn btn-default" id="mode_dir" onChange={props.changeDirective}>
                                    <option value="none" defaultValue>Directives</option>
                                    <option value="cmpr_80">Compression to 80</option>
                                    <option value="r_90">Rotate 90 degrees</option>
                                    <option value="cr_100,100,300,300">Cropping the image</option>
                                    <option value="s_50">Sharpen Image</option>
                                   </select>
                                   
                                   <select className="btn btn-default" id="usr_fit">
                                    <option value="fit_method" defaultValue>Fit Method</option>
                                   </select>
